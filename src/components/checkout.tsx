                    ...
                    <div className="col-span-2">
                        <div>
                            ...
                            <div className="mt-5 pt-5 border-t-2">
                                ...
                                <a href="/thanks" className="pointer-events-auto rounded-md bg-indigo-600 py-4 px-3 text-lg text-center text-white hover:bg-indigo-500 uppercase block mt-4">Place Order</a>
                            </div>
                        </div>
                    </div>
