                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                    <div className="col-span-2">
                        <div>
                            ...
                            <div className="mt-5 pt-5 border-t-2">
                                <PaymentMethod />
                                <div class="flex items-center pt-3 mt-3 border-t-2">
                                    <input id="default-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                    <label for="default-checkbox" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">I’ve read and accepted all Terms & Conditions</label>
                                </div>
                            ...
                            <div className="">
                                {cartItems.map((item) => (
                                    <li key={item.id} className="flex flex-col">
                                        <CartItem {...item} getItemQuantity={getItemQuantity} view='checkout' />
                                    </li>
                                ))}
                            </div>
