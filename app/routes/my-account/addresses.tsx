        ...
        <div className="grid grid-cols-2 gap-4">
          {addresses.length === 0 ? (
            <div className="w-full text-center">
              <p className="py-4 mb-5 text-lg text-gray-500">There are no addresses yet</p>
              <a href="/" className="inline-flex justify-center px-10 py-2 text-sm font-semibold text-white rounded-lg bg-slate-900 hover:bg-slate-700">Add Address</a>
            </div>
          ) : (
