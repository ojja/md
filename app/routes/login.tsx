        ...
        <div className="">
          <div className="flex flex-wrap -mx-4 min-w-[525px]">
            <div className="relative w-full px-4">
              ...
              >
                <h1 className="mb-4 text-2xl font-extrabold leading-none tracking-tight text-center text-gray-900">{t('login')}</h1>
                {errors.general && (
                ...
                {t('not_member')} <Link to="/signup" className="text-primary hover:underline" > {t('sign_up')} </Link>
                </p>
                <Dots />
              </div>
            </div>
