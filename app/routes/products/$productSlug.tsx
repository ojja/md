                                ...
                                <div className=" pt-9 mb-6">
                                    ...
                                    {salePrice && salePrice !== productPrice ? (
                                        <p className="flex items-end  gap-x-3">
                                            <span className=" w-fit bg-yellow-910 rounded h-[26px] flex rtl:flex-row-reverse gap-x-[2px] px-1 mt-5 text-5xl">
                                                {/* {FormatCurrency(salePrice, getSelectedCurrency(), ["text-xl font-normal", " text-5xl font-semibold ltr:-ml-0.5 rtl:-mr-0.5", "text-xl font-normal"])} */}
                                            </span>
                                            <del className="text-gray-400 text-sm line-through ">
                                                {/* {FormatCurrency2(productPrice, getSelectedCurrency())} */}
                                            </del>
                                        </p>
                                    ) : (
                                        <p className=" w-fit bg-yellow-910 rounded h-[26px] flex rtl:flex-row-reverse gap-x-[2px] px-1 mt-5 text-5xl">
                                            {/* {FormatCurrency(salePrice, getSelectedCurrency(), ["text-xl font-normal", " text-5xl font-semibold ltr:-ml-0.5 rtl:-mr-0.5", "text-xl font-normal"])} */}
                                        </p>
