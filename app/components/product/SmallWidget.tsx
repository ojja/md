    ...
    return (
        <div className="flex items-center w-full p-4 border-b border-gray-300">
            ...
            <div className="flex flex-col flex-1 ml-4">
                ...
                <span className="  w-fit bg-yellow-910 rounded h-[18px] flex rtl:flex-row-reverse gap-x-[2px] px-1 text-5xl">{FormatCurrency(product.price , 'EGP' , ["text-sm font-normal", "text-2xl font-semibold ltr:-ml-0.5 rtl:-mr-0.5", "text-sm font-normal"])}</span>
            </div>
            <div className="">
