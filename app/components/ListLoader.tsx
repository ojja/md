        ...
        <div>
            <div className="animate-pulse">
                <div className="flex flex-col flex-wrap items-baseline justify-between pt-2 pb-6 mb-4 border-b border-gray-200 md:flex-row">
                    <div className="w-64 h-8 bg-red-100 rounded-md"></div>
                    <div className="w-32 h-8 bg-red-100 rounded-md"></div>
                </div>
                <div className="flex justify-between pb-4 border-b border-gray-200">
                    <div className="w-96 h-4 bg-red-100 rounded-md"></div>
                </div>
                        ...
                        <div>
                            <div>
                                <div className="py-6 border-b border-gray-200">
                                    <div className="w-full h-4 bg-red-100 rounded-md"></div>
                                </div>
                                <div className="py-6 border-b border-gray-200">
                                    <div className="w-full h-4 bg-red-100 rounded-md"></div>
                                </div>
