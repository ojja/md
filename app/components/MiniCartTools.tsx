        ...
        <div className="pt-4 py-4 mt-4 parent bg-[#f5f5f5]">
            <div className="flex items-center justify-center">
                <Tooltip message={'Add Note'}>
                    <span className="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center cursor-pointer mr-4" onClick={toggleNote}>
                        <PencilSquareIcon className="w-6 h-6 text-gray-500" />
                    </span>
                </Tooltip>
                <Tooltip message={'Add A Coupone'}>
                    <span className="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center cursor-pointer mr-4" onClick={toggleCoupone}>
            ...
            >
                <div className="absolute left-0 right-0 bottom-0 p-4 bg-gray-200">
                    <button
                        type="button"
                    ...
                    <div className="flex w-full mt-2 coupon">
                        <input type="text" name="coupon_code" className="w-full p-2 border border-gray-300 rounded-l outline-none bg-gray-50" id="coupon_code" value="" placeholder="Enter Coupon Code" />
            ...
            >
                <div className="absolute left-0 right-0 bottom-0 p-4 bg-gray-200">
                    ...
                    <div className="flex w-full mt-2 coupon">
                        <input type="text" name="order_note" className="w-full p-2 border border-gray-300 rounded-l outline-none bg-gray-50" id="order_note" value="" placeholder="Add Order Note" />
                        <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-r text-sm w-full sm:w-auto px-5 py-2.5 text-center " name="add_note" value="Add">Add</button>
                    </div>
                </div>
            </div>
        </div>
