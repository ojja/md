                    ...
                    <div className="relative flex flex-col items-start w-full p-3 pb-4 md:py-6 md:px-6 md:w-3/5">
                        ...
                        <div className="mb-4">
                            ...
                            <h4 className="pt-3 pb-3 font-bold md:text-2xl after:bg-primary-700">
                                {i18next.language === "ar" ? (recipe.ar_title || recipe.title) : recipe.title}
                            </h4>
                            <div className="text-base text-gray-50" dangerouslySetInnerHTML={{ __html: i18next.language === "ar" ? (recipe.ar_content || recipe.content) : recipe.content }} />
                        </div>
