                            ...
                            <>
                                <dt className="text-lg">
                                    <Disclosure.Button className="flex items-start justify-between w-full text-left text-gray-400">
                                        <span className="text-base font-bold text-white"> {i18next.language === "ar" ?
                                            menu.title : menu.title_en
                                        }</span>
                                        <span className="flex items-center ml-6 h-7">
                                            <ChevronDownIcon
                                                className={classNames(open ? '-rotate-180 text-white' : 'rotate-0', 'h-6 w-6 transform text-white')}
                                                aria-hidden="true"
                                            />
                                        </span>
                                    </Disclosure.Button>
                                ...
                                <Disclosure.Panel as="dd" className="pr-12 mt-2">
                                    <ul>
                                        {menu.pages.map((page, index) => (
                                            ...
                                            <li className="text-white md:text-xl md:mb-2 hover:text-gray-100" key={index}>
                                                <Link className="" to={page.url}> {i18next.language === "ar" ?
