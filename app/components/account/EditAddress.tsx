    ...
    return (
        <div className="relative">
            {isLoading ?
                ...
                : ''}
            <h3 className="mb-3">{t('common.edit_address')}</h3>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="space-y-4">
                    ...
                    <button type="submit" className="inline-flex justify-center w-full px-3 py-4 text-sm font-semibold text-center text-white rounded-md bg-slate-900 hover:bg-slate-700">{t('common.edit_address')}</button>
                </div>
            </form>
        </div>
    )
